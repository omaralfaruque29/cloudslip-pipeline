...
import com.cloudslip.pipeline.config.properties.KafkaCloudslipProducerProperties;
import com.cloudslip.pipeline.config.properties.SSLProperties;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, String> kafkaCloudslipProducerFactory(KafkaCloudslipProducerProperties kafkaCloudslipProducerProperties) {
        ...
        configProps.putAll(KafkaSslConfig.mapToKafkaProperties(sslProperties));
